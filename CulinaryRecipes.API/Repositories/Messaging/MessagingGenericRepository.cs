...
{
    public class MessagingGenericRepository<T> : IMessagingGenericRepository<T> where T : IEntity
    {
        private readonly IMessagingGenericDao<T> _dao;

        public MessagingGenericRepository(IMessagingGenericDao<T> dao)
        {
            _dao = dao;
        }
